...
public class KeyCodec {
    ...
    private static FidoUafAuthenticator fidoUafAuthenticator = FidoUafAuthenticator.getInstance();
    ...
    public static KeyPair getKeyPair(String rpName)
            throws InvalidAlgorithmParameterException,
            NoSuchAlgorithmException, NoSuchProviderException {
        //ECGenParameterSpec ecGenSpec = new ECGenParameterSpec("prime192v1");

        try {
            return fidoUafAuthenticator.createKeyPair(rpName);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
        // TODO I should remove lines below
...
//        return getKeyAsRawBytes((BCECPublicKey) getPubKey(Base64.decodeBase64(base64EncodedPubKey)));
        return getKeyAsRawBytes((ECPublicKey) getPubKey(Base64.decodeBase64(base64EncodedPubKey)));
    }
...
//    }
    ...
    // TODO Emerson
    public static byte[] getKeyAsRawBytes(ECPublicKey pub) throws IOException {
        byte[] raw;
        ByteArrayOutputStream bos = new ByteArrayOutputStream(65);
